...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Image Converter Right" },
      { name: "description", content: "Image converter for all types" },
      { name: "author", content: "Image Converter Right" },
      { property: "og:title", content: "Image Converter Right" },
      { property: "og:description", content: "Image converter for all types" },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@ImageConverterRight" },
      { name: "twitter:title", content: "Image Converter Right" },
